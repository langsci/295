...
\glt `The old woman was taking the (well-spun) thread$_i$ here and there in the yard of the king, and the king$_j$ saw it$_i$ as it$_i$ dazzled his$_j$ eyes (i.e. it$_i$ was so well spun that it was dazzling bright).'  (Norbzang 2012)
...
\ex \label{ex:padma.tWtWNu.nA}
 ...
 \glt `If you (really) are Padma 'Od'bar, recite [the mantra] that I have taught you.' (Norbzang 2005)
\end{exe}
...
\glt `Ever since your father went (to the mission) like that, he has not come back.' (Norbzang 2005)
\end{exe}  
...
\glt `Now that we have become old and useless, we became like this, they drink our [blood] with straws (planted in our back).' (Norbzang 2005)
\end{exe}
...
\glt `When you have become old, they will drink you [your blood] like this with a straw (planted on your back)' (Norbzang 2012)
(\japhdoi{0003768\#S58})
\end{exe}
...
\glt `I am hungry while staying here, but today the heavens have sent me down [these humans to eat].' (Norbzang 2012)
...
\glt `Maybe Padma 'Od'bar came back in the last few days, since there is smoke coming out from their house.' (Norbzang 2012)
