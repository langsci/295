...
\glt `[The lions] start eating its flesh before it dies (i.e. while it is still alive).' (20-sWNgi, 47)
  \end{exe} 
...
\glt `[Dogs]$_i$ cannot chew [\forme{pɤŋɤxɕaj}]$_j$ (a type of grass) into fine parts, and it$_j$ causes them to vomit.' (140505 panaxCAj, 4)
\end{exe} 
...
\glt `The [inchworm] moves as if it were measuring the ground span by span, and otherwise it is not able fly.' (26-qambalWla, 80)
\end{exe}
...
\glt `[The solar eclipse] lasted enough time for the birds to start singing (as if night had come).' (29-RmGWzWn, 34)
\end{exe}
...
\glt `It started singing (i.e. began a song).' (140519 yeying-zh, 80)
\end{exe}
...
In addition, when a complement-taking verb is itself in the subject participle form, it is possible for the complement either to be in the expected form (infinitive or finite), or to be in the subject participle form itself. For instance, in example (\ref{ex:ndZikWsAndu}) the subject participle \forme{kɯ-cʰa} `the one who can' takes a complement whose verb is a subject participle with a possessive prefix coreferent with the object (\forme{ndʑi-kɯ-sɤndu}), instead of the expected \forme{kɤ-} infinitive (or finite clause).
...
\glt `He placed [the leaf of a rhododendron] like a flat stone [next to his younger brother's$_i$ mouth] in such a way that water could flow in his$_i$ mouth.' (2011-05-nyima, 63-64)
\end{exe}
...
\glt `You have spoiled my water, you caused me to be unable to drink clear water.' (lang he yang-zh, 26)
\end{exe}
...
\glt `(I will not kill you), but I will have you stay under the cliffs, in such a way that the water flows down onto you.' (150901 changfamei-zh, 162)
\end{exe}
...
\glt `Although its ingredients are the same (as those used to make other types of alcohol), [some people] consider alcohol in a bucket to be more tasty.' (30-thoNraR, 16-17)
\end{exe}
...
\glt `After she had finished milking, ...' (2014-kWlAG, 230)
\end{exe} 
...
\glt `Now it is not allowed to do these things (i.e. kill whales).' (160703 jingyu, 61)
\end{exe} 
%nɤ-kɤ-rɤthu pɯ-jɤɣ
%divinitation, 93
...
\glt `(As he spends all his time singing rather than working, in the end) he did not succeed in building his house.' (26-NalitCaRmbWm, 52)
\end{exe}
...
\glt `They can only meet each other (i.e. they are not allowed by the gods of heaven to meet more than) once a year.' (150828 niulang-zh, 184)
\end{exe}
...
my mother is up there, come and ask her (about it) as suits you.' (2003 sras, 65)
\end{exe} 
...
\glt `When (piglets and lambs) have grown up, [if the eagle tries to] take away [one of them]$_i$, it$_i$ struggles and [the eagle] is not strong enough to take it$_i$ away.' (150819 RarphAB, 6)
\end{exe}	
...
The transitive subject of the infinitival clauses \forme{kɤ-tsɯm} and \forme{ʑaʑa ʑo kɤ-sat} in (\ref{ex:mWYWwGsWxcha}) and (\ref{ex:kAsat.mAwGsWxcha}) is here coreferent with the causee of \forme{sɯx-cʰa}. Since \forme{cʰa} is morphologically intransitive, this causee is syntactically equivalent to the direct object. It is one of the rare complement-taking verbs with obligatory object-subject coreference (§\ref{sec:velar.inf.coreference}).
...
\glt   `When you want to listen to my songs, send people to come and invite me and that's it.' (140519 yeying-zh, 249)
\end{exe}
...
\glt `We neither saw where she came from, nor can we remember towards which direction she disappeared.' (2003 sras, 38)
 \end{exe}
...
\ex \label{ex:kAsat.tAkWrANgat}
 ...
 \glt `When you go there, you will see two persons who are about to be killed.' (140507 jinniao-zh, 320)
\end{exe} 
...
\glt `One cannot address a woman as `my uncle'.' (140425 kWmdza 02, 99)
\end{exe} 
...
\glt `[The monkey mother] made [a sign to the hunter] meaning `Please don't shoot yet, I still have to nurse my baby.' (...) and once she had finished, she put her baby aside like that, and made a sign like that meaning `(now) you can shoot'.' (19-GzW, 73-74)
\end{exe}
...
\glt `The fat monk did not feel like (going down the river and) bringing the water [up to the monastery]. (150830 san ge heshang-zh, 105)
\end{exe} 
