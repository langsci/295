...
\glt  `Sometimes [dogs] have three or four [puppies], some only have two.' (05-khWna, 22)
\end{exe} 
...
\glt `My tomb is there, if you take out my bones, ...' (150907 niexiaoqian-zh, 109)
\end{exe}
...
\glt `Father, the one down there, I don't know if he is a [boy] born in the year of the Tiger, to be thrown [into the lake], but...' (2011-05-nyima, 154)
\end{exe}
...
\ex \label{kha.nW.thamCAt}
 ...
 \glt `There was more of us [than before], and so many of us could not fit in the house.' (14-siblings, 103-104)
 \end{exe}
...
\glt `We brother and sisters were born in intervals of two years each.' (if ranked by birth order, adjacent siblings differ in age from each other by two years each) (14-siblings, 243)
 \end{exe}
...
\glt `A very beautiful girl came [out of the skin].' (31-deluge, 50)
\end{exe}
...
\ex \label{ex:RnWz.nWnW} 
 ...
 \glt `He$_i$ (i.e. the butcher) met two wolves. He$_i$ met two wolves, and the butcher$_i$ was very much afraid.' (150902 liaozhai lang-zh, 7-8)
\end{exe}
...
\glt ``To attach' [means] `to put together', `to attach something with something like a rope or a thread.''  (150902 kAxtCAr, 2-3)
\end{exe}
...
\ex \label{ex:aZo.kWnA.akAsWso}
 ...
 \glt `(I will do as you say, but) do also the things that I want.' (2003kAndzwsqhaj2, 47)
\end{exe}
...
\glt `[Gentlemen] would [wear trousers that did] not cover much even their knees.'  (30-rkAsnom, 5) 
  \end{exe}
...
\glt `Not even one [of the thieves] looked at it.' (`The thieves did not even so much as looked at it.') (140426 luozi he qiangdao-zh, 30)
\end{exe}
...
\glt `Falcons and eagles take [the moles] and eat them.' (28-qapar, 201)
\end{exe}
...
\glt `Gentlemen and ladies each have [different] seating places.' (31-khAjmu, 10)
\end{exe}
