...
\glt `Both copper and brass can get verdigris.' (30-Com)
(\japhdoi{0003736\#S99})
\end{exe}
...
\glt `Her parents would not be parted from her.' (14-siblings) (\japhdoi{0003508\#S275})
\end{exe}
...
\glt `Its seeds attach on clothes in clusters.' (18-qromJoR)
...
\glt `When [the râkshasas] will be about to catch up with me, I will turn this little ring towards west [in their direction].' (28-smAnmi) (\japhdoi{0004063\#S209})
\end{exe}
...
\glt `Tell me all about what happened to my father.' (Norbzang 2005)
\end{exe}
...
\textsc{3pl}.\textsc{poss}-companion animal \textsc{3sg}.\textsc{poss}-\textsc{sbj}:\textsc{pcp}-eat all \textsc{dem}:\textsc{pl} \textsc{3pl}.\textsc{poss}-name all beast \textsc{ipfv}-\textsc{genr}-say be:\textsc{fact} \\ 
 \glt `All those that eat the other animals, their name, all of them, is `beast'.'  (150822 kWrNi)
(\japhdoi{0006260\#S7})
\end{exe}
...
\glt `All of his companions took [other women] as their wives.' (Norbzang 2005)
\end{exe}
...
\glt `They became kings of this place, and treated well the whole population.' (Norbzang 2005)
  \end{exe}
...
\glt `Even like that [despite the pain in her legs], she props herself with a cane using one hand,(and does all kinds of things with her other hand)' (14-siblings) (\japhdoi{0003508\#S49})
\end{exe}
...
\glt `May you become a real human, a nice, young and beautiful girl.' (said to a râkshasî) (Norbzang 2005)
\end{exe}
