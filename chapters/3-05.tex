...
The adverb \japhug{ʁnaʁna}{both} commonly co-occurs with dual, as in (\ref{ex:ni.RnaRna});
. It is exterior to the noun phrase, and must thus follow \forme{ni} and all other postnominal determiners.
...
\ex \label{ex:paznAkharnW}
 ...
 \textsc{2sg}.\textsc{poss}-elder.sibling \textsc{du} \textsc{erg} \textsc{2sg} come.back:\textsc{fact} \textsc{inf}-think \textsc{erg} soldier three-round \textsc{erg} \textsc{aor}:3\fl{}3'-\textsc{caus}-surround-\textsc{pl} be.\textsc{aff}:\textsc{fact} \textsc{lnk} \\
...
The plural marker \forme{ra} is also used as a honorific marker on terms of address as \forme{a-ʑi ra} `my young lady' in (\ref{ex:aZi.ra}), correlating with the plural possessive prefix \forme{nɯ-} and sometimes plural indexation (§\ref{sec:honorific.indexation}).
...
\ex \label{ex:WkWki.arZaB.kWki}
 ...
 \textsc{dem} \textsc{3sg}.\textsc{poss}-wife \textsc{dem} \textsc{erg} \textsc{dem}.\textsc{prox}.\textsc{emph} \textsc{1sg}.\textsc{poss}-wide \textsc{dem}.\textsc{prox} \textsc{dem}.\textsc{prox} muntjac \textsc{dem}.\textsc{prox}  \textsc{aor}:3\fl{}3'-\textsc{caus}-become \textsc{lnk} \\
...
\textsc{lnk} \textsc{3sg}.\textsc{poss}-companion \textsc{pl} \textsc{total}\redp{}\textsc{sbj}:\textsc{pcp}-exist \textsc{erg} \textsc{3pl}.\textsc{poss}-wife \textsc{aor}:3\fl{}3'-\textsc{auto}-look.for-\textsc{pl} \textsc{sens}-be \\
...
\textsc{3pl} \textsc{erg} the.aforementioned place  \textsc{gen} \textsc{3sg}.\textsc{poss}-king \textsc{aor}:3\fl{}3'-\textsc{auto}-take-\textsc{pl} \textsc{lnk} whole population \textsc{emph} \textsc{aor}:3\fl{}3'-do.good-\textsc{pl} \textsc{sens}-be \\
...
king each.better.than.the.other \textsc{erg} \textsc{aor}:3\fl{}3'-ask-\textsc{pl} be.\textsc{aff}:\textsc{fact} \textsc{lnk} \textsc{neg}-\textsc{aor}-agree-\textsc{1sg} \\
...
\ex \label{ex:ci.ra2}
 ...
 animal \textsc{aor}-not.exist \textsc{irr}-\textsc{pfv}-die \textsc{lnk} \textsc{dem} dhole \textsc{erg} \textsc{aor}:3\fl{}3'-eat be:\textsc{fact} \textsc{sfp} \textsc{ipfv}-say-\textsc{pl} be.\textsc{aff}:\textsc{fact} \textsc{lnk}  \\
...
However, although nouns phrases followed by \forme{nɯ} and \forme{nɯnɯ} more often than not denote definite referents, these determiners cannot be analyzed as definite determiners, as noun phrases with \forme{nɯ} or \forme{nɯnɯ} can in certain cases have indefinite referents. 
...
\gll  tɕe ɯ-ndzɤtsʰi ka-tsɯm-nɯ nɯtɕu qʰe tɕe,   \\
 \textsc{lnk} \textsc{3sg}.\textsc{poss}-meal \textsc{aor}:3\fl{}3'-bring-\textsc{pl} \textsc{dem}:\textsc{loc}  \textsc{lnk} \textsc{lnk}    \\
...
\ex \label{ex:tWrpa.thafse}
 ...
 \textsc{lnk}  \textsc{anthr} \textsc{erg} the.aforementioned axe \textsc{aor}:3\fl{}3'-whet \textsc{dem} \textsc{ifr}-take \textsc{lnk} \\
...
The use of \forme{iɕqʰa} as a topic marker with nouns (as in \ref{ex:iCqha.kAtWm} above) probably took place by reanalysis of the adverb in headless or postnominal relatives, or in complement clauses as above, then generalized to all noun phrases even those without subordinate clause.
...
\textsc{3sg}.\textsc{poss}-companion \textsc{pl} also \textsc{3sg}.\textsc{poss}-wife each \textsc{aor}:3\fl{}3'-\textsc{auto}-search \textsc{sens}-be \\
...
\ex \label{ex:karGi.Zo.kWfse.ma.me}
 ...
 \textsc{3sg}.\textsc{poss}-fruit \textsc{dem} \textsc{aor}:3\fl{}3'-throw just \textsc{lnk}  \textsc{sbj}:\textsc{pcp}-\textsc{emph}\redp{}small \textsc{emph} apart.from not.exist:\textsc{fact} turnip.seed \textsc{emph} \textsc{sbj}:\textsc{pcp}-be.like apart.from not.exist:\textsc{fact} \\
...
\textsc{anthr} \textsc{erg} \textsc{1sg}.\textsc{poss}-phone other \textsc{aor}:3\fl{}3'-buy \\
...
\textsc{1sg}.\textsc{poss}-younger.sibling \textsc{erg} house other \textsc{aor}:3\fl{}3'-\textsc{auto}-\textsc{caus}-make \textsc{lnk} \\
...
The most common type of prenominal modifiers are placenames and other unpossessible nouns (§\ref{sec:place.names}) and nouns expressing the material from which an object is a made, as \japhug{χsɤr}{gold}, \japhug{rŋɯl}{silver} and \japhug{si}{wood} in (\ref{ex:rNWl.rJAskAt}).
...
When a prenominal modifier is present, possessive prefixes on inalienably possessed head noun can be neutralized to indefinite possessor  (§\ref{sec:possessive.prefixes.prenominal}). 
