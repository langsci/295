...
in particular \forme{ɯ-mat+tsʰoʁ} `bear fruits' (see examples \ref{ex:sqamNuxpa.koRmWz}, §\ref{sec:temporal.postpositions} or \ref{ex:Wmat.kukWtshoR}, §\ref{sec:dummy.subj.object.relativization}). Its anticausative \japhug{ndzoʁ}{be attached to} (§\ref {sec:ndzoR.light.verbs}) also occurs with the same meaning.
