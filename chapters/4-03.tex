...
\ex \label{ex:pjAkAwGronWci}
 ...
 \glt `They were playing.' (140510 fengwang-zh, 33) (\japhdoi{0003939\#S33})
\end{exe}
...
\glt `On the side of the road, there was a tree, one half of that tree was dry and the other half was green. (The divination2002)
\end{exe}
...
\glt `[They] came down from heaven.' (150828 niulang-zh, 48) (\japhdoi{0006318\#S48})
\end{exe}
...
\glt `He ran out into the yard.' (140505 bulaimei-zh, 106) (\japhdoi{0003911\#S104})
\end{exe} 
...
\glt `He became hungry, took a piece of bread from the folds of his clothes and ate it.' (150830 san ge heshang-zh, 139) (\japhdoi{0006416\#S129})
\end{exe}
...
\glt `I am going [to heaven] with you, I cannot stay here alone.' (02-deluge, 79) (\japhdoi{0003376\#S74})
\end{exe}
...
\glt `Take me with you [to heaven].' (31-deluge, 70) (\japhdoi{0004077\#S71})
 \end{exe}
...
\glt `As he moved closer, he saw that [the people about to be executed] were his brothers.' (140507 jinniao-zh, 334) (\japhdoi{0003931\#S318})
\end{exe}
...
\glt `He went [after them] until he became tired.' (160706 poucet6, 45) (\japhdoi{0006109\#S45})
\end{exe}
...
\begin{exe}
	...
	\glt `In the west from there, he came upon a white lake.' (28-smAnmi, 102) (\japhdoi{0004063\#S97})
\end{exe}
...
\glt `People say `I will go (down) to Rqakyo', or `I went [down] to Smeliu', this is because one has to go up a mountain and go down on the east side.' (150904 akW andi-zh, 16) (\japhdoi{0006372\#S15})
\end{exe}
...
\glt `The mudslide swept the power station. It swept the power station, and when the landslide happened, it took away a cow that was grazing [there].' (160715 nWNa)
(\japhdoi{0006067\#S3})
\end{exe}
...
\glt `I went to Tshobdun to teach.' (150819 kumpGa, 78) (\japhdoi{0006388\#S69})
\end{exe}
...
\glt `I came to Mbarkham to study.' (140501 tshering skyid, 48) (\japhdoi{0003902\#S48})
\end{exe}
...
\glt `We (in Kamnyu) say ``I went (eastwards) to Sarndzu.' (150904 akW andi, 21) (\japhdoi{0006372\#S21})
\end{exe}
...
\glt `The elders [sit] higher (i.e. upstream).' (31-khAjmu, 61) (\japhdoi{0004079\#S59})
\end{exe}
...
\glt `Nephews could not be seated higher (i.e. upstream) than their maternal uncles.' (08-saCW, 12) (\japhdoi{0003462\#S12})
\end{exe}
...
\glt `In the [generation] below [that of my nephews], I say \forme{a-ɣe} `my grandchild' (to all grandnephews), whether they are my brother's grandchildren or my sister's granchildren.' (140425 kWmdza02, 16)
\end{exe}
...
\glt  `It was so nice there that he did not realize that [a lot of] time had passed.' (28-smAnmi, 290) (\japhdoi{0004063\#S273})
\end{exe}
...
\glt `Several months passed, but ...' (140513 mutong de disheng-zh, 13) (\japhdoi{0003977\#S11})
\end{exe}
...
\glt `Come inside the house.' (140507 tangguowu-zh, 90) (\japhdoi{0003933\#S87})
\end{exe}
...
\glt `She came out of the house.' (140428 xiaohongmao-zh, 28) 	(\japhdoi{0003884\#S27})
\end{exe}
...
\glt `The load the bullet into the [trunk] of the musket from the opening [the muzzle]' (28-CAmWGdW, 38) (\japhdoi{0003712\#S37})
\end{exe}
...
\glt `The gunpowder flares and drives the bullet out (of the trunk of the muzzle).' (28-CAmWGdW)
...
\glt `He unsheathed his sword.' (140514 huishuohua de niao-zh, 178) (\japhdoi{0003992\#S166})
\end{exe}
...
\glt `The needle has a hole at the [needle's] eye$_i$, and one passes the thread though it$_i$.' (12-kAtsxWb) (\japhdoi{0003486\#S29})
\end{exe}
...
\glt `When it sings, it does like that with its wings, like it is about to fly, it [repeatedly] spreads its wings and then folds them.' (24-ZmbrWpGa)
...
\glt `She threw them$_i$ down there, and her children tore them$_i$  apart (pulled them$_i$  right and left in a disorderly way).' (2012 Norbzang, 401) (\japhdoi{0003768\#S349})
\end{exe} 
...
\glt `The zigzags go left and right.' (140522 Kamnyu zgo, 39) 	(\japhdoi{0004059\#S37})
\end{exe} 
...
\glt `They put the firewood on the \textsc{westwards} seating place (that is opposite the men's \textsc{eastwards} seating place).' (31-khAjmu, 36) (\japhdoi{0004079\#S36})
\end{exe}
...
\glt `As the intersection of the [upper and lower] warp threads goes down, one does like that to tamp it down.' (vid-20140429090403, 62) (\japhdoi{0003776\#S57})
\end{exe} 
...
\glt `In winter, [the bear] hibernates.' (21-pri, 51) (\japhdoi{0003580\#S49})
\end{exe}
...
\glt `Trees whose inside is hollow, whose inside is dried, [the bear] hollows it completely, goes up [the hole] and hibernates there.' (21-pri, 55) (\japhdoi{0003580\#S53})
\end{exe}
...
\glt `On the road (from Kamnyu) towards Mengi...' (140522 Kamnyu zgo, 2) (\japhdoi{0004059\#S2})
\end{exe}
...
\glt `Mengi is on the east, and Praqwu (a small locality in Kamnyu) is on the west.' (140522 Kamnyu zgo, 21) (\japhdoi{0004059\#S21})
\end{exe}
...
\glt `Even water could not go [down his throat], he could not drink anymore.' (of a person suffering from throat cance) (27-tWfCAl, 81) (\japhdoi{0003710\#S87})
\end{exe}
...
\glt `The juniper grows very high.' (08-CAG, 1) (\japhdoi{0003442\#S1})
 \end{exe}
...
\glt `Now they are even more numerous than before.' (140522 tshupa, 86) (\japhdoi{0004053\#S84})
\end{exe}
...
\glt `He had come to be born in their [family].' (150825 nezha naohai-zh, 38) (\japhdoi{0006272\#S35})
\end{exe}
...
\glt `It lays eggs in the fields.' (24-kWmu, 85) (\japhdoi{0003618\#S80})
\end{exe}
...
\glt `The trees on the mountain became fewer and fewer.' (04-xiaocunzhuang-zh, 24) (\japhdoi{0003394\#S24})
\end{exe} 
...
\glt `Her husband passed away.' (12-BzaNsa, 127) (\japhdoi{0003484\#S111})
\end{exe} 
...
\glt `They killed their cow (for themselves to eat).' (02-deluge2012, 17) (\japhdoi{0003376\#S16})
\end{exe} 
...
\glt `Whether it is sinew$_i$ from a domestic or a wild animal,$_j$  after they butcher them,$_j$ they take it$_i$ out and dry it$_i$.' (150906 tWNgru, 6) (\japhdoi{0006304\#S5})
\end{exe} 
...
\glt `After [the hunters] have killed [the animals]$_i$, they bring them$_i$ home and butcher them$_i$.' (150829 KAGWcAno, 18) (\japhdoi{0006420\#S17})
\end{exe} 
...
\glt `The cicada [was] singing all the time during the day. (26-NalitCaRmbWm, 30) 	(\japhdoi{0003676\#S29})
\end{exe} 
...
\glt `He played the flute' (140513 mutong de disheng-zh, 85) (\japhdoi{0003977\#S77})
\end{exe}
...
\glt `She heard [the hunters] blowing the horn.' (140520 ye tiane-zh, 249) (\japhdoi{0004044\#S234})
\end{exe}
...
\glt  `One blows [into the pig's trachea] and its lungs fill up.' (20-kAPjAt, 13) (\japhdoi{0003556\#S12})
\end{exe}
...
\glt `[The fly that has been caught in the spider's web] moves and moves, and the spider staying inside feels it.' (26-mYaRmtsaR)
(\japhdoi{0003674\#S58})
\end{exe}
...
\glt `Heavens gave it to me.' (2005 Norbzang, 312)
\end{exe}
...
\glt `When the hen falls asleep, it closes its eyes. Its nictitating membrane (literally: `eye husk') comes down and covers its eyeball.' (150819 kumpGa, 52) (\japhdoi{0006388\#S46})
\end{exe}
...
\glt `They built a house.' (02-deluge2012, 131) (\japhdoi{0003376\#S121})
\end{exe}
...
\glt `[The wild yaks] come and drink water.' (20-RmbroN, 46)  (\japhdoi{0003560\#S43})
\end{exe}
...
\glt `She went [there] and drank water.' (140428 mu e guniang-zh, 72) (\japhdoi{0003880\#S66})
\end{exe}
...
As shown by the close phonetic resemblance between the motion verbs and the corresponding AM prefixes, there is little doubt that the latter have been grammaticalized from the former,\footnote{Exceptions however include the cislocative \forme{ɟɐ-} in Bragbar Situ, whose origin is not straightforward \citep{zhangshuya20these}, and the case of Zbu, where the motion verb \forme{xwéʔ} is unrelated to the AM prefix. } probably through a paratactic or serial verb construction in which motion verbs occurred in direct contact with the lexical verb without intervening linker. 
...
\glt `He went up there, climbing,on the very high mountain.' (150825 huluwa-zh, 156) (\japhdoi{0006346\#S151})
\end{exe}
...
The grammaticalization of motion verbs to AM prefixes, from a construction similar to that in (§\ref{sec:toCe.tonWrRWrRa}), occurred in the common ancestor of all Gyalrong languages, rather than independently in each language, as is shown by the fact that the transitive verb `to bring, to fetch' (Japhug \forme{ru}, Bragbar Situ \forme{ró} / \forme{rô}) shares a common irregularity in all languages \citep{jacques13harmonization}: it must appear with an associated motion prefix. In examples (§\ref{sec:CtAruta}) and (§\ref{sec:rECAroN}) from Japhug and Situ removing the AM prefix would result in incorrect forms (§\ref{sec:ru.fetch}).
...
The cislocative prefix on the other hand lacks any allomorphy, and its initial consonant is identical to that of the verb `come' (with its main vowel either converted to a schwa or identical to that of the verb stem in the case of Cogtse) in almost all languages including Tshobdun (where \forme{o-} comes from \forme{*wə\trt}, the reduced form of \forme{wî} `come'), the only possible exception being the Bragbar dialect of Situ. It is therefore possible that each Gyalrong language has independently innovated a cislocative prefix from its verb `come' after the breaking up of proto-Gyalrong, and that the proto-Gyalrong only had one AM prefix with neutral deixis. The introduction of a cislocative AM affix grammaticalized from the verb `come' in a system which originally only comprised a single AM marker is attested in Manchu \citep{fuente18am}, and a similar process may have taken place in Gyalrong languages.
...
\glt `[The rabbit], he had fled away, otherwise he would have been eaten.' (140427 qala cho kWrtsag, 76) (\japhdoi{0003852\#S71})
\end{exe}
...
\ex \label{ex:GWndze}
 ...
 \glt `It does not come and eat crops.' (23-pGAYaR, 26) (\japhdoi{0003606\#S21})
\end{exe}
...
\glt `People from the Chinese areas, people from outside send people here to buy [matsutake].' (20 grWBgrWB 58)  (\japhdoi{0003554\#S57})
\end{exe} 
...
\ex \label{ex:ZlumWrkia}
 ...
 \glt `(Tomorrow  morning) I will go downstream to steal from Tamuj Jlarukyarna, I will steal the water from the goat's horn, but when [the mountain god] comes after me...' (25-kAmYW-XpAltCin)
(\japhdoi{0003642\#S29})
\end{exe}
...
\glt `The larch grew on a place higher than the fir, but nephews could not be seated higher (i.e. upstream) than their maternal uncles (and this is why the larch became deciduous).' (08-saCW) (\japhdoi{0003462\#S11})
\end{exe}
...
\glt `The dwarfs went everyday into the forest, searched around and collected gold there. ' (140504 baixuegongzhu-zh)
(\japhdoi{0003907\#S94})
\end{exe} 
...
\glt `The eagle, (in the case of animals that are too big), it has to kill them by hitting them with its wings, and then take them away and  eat them.' (50819 RarphAB)
(\japhdoi{0006356\#S3})
\end{exe}
...
\glt `One [of the two men] prepared tea, the other one went up the tree to stand guard. He went up, and as he was staying there, he saw [down there] that the tea had boiled and was about to boil over.' (26-tAGe, 7) 	(\japhdoi{0003686\#S3})
\end{exe}
...
\begin{exe}
	...
	\glt `Take this girl [to the forest] and kill her.' (140504 baixuegongzhu-zh, 39) 	(\japhdoi{0003907\#S38})
\end{exe}
...
\glt `It goes and collects the walnuts that have fallen [on the ground] one by one, and goes [to its nest] and buries them [there].' (28-qapar, 181) (\japhdoi{0003720\#S174})
\end{exe}
...
\glt `He went there and had a look up there, but the other ones had not [yet] disappeared.' (tWJo 2005, 74) (\japhdoi{0004089\#S71})
\end{exe}
...
\glt `To whose house have you gone and done some sewing, say it.' (140512 alibaba-zh, 164) (\japhdoi{0003965\#S156})
\end{exe}
...
\glt `It was the time to [go and] make offerings for the graves.' (160630 abao-zh, 70) (\japhdoi{0006197\#S67})
 \end{exe} 
...
\gll  tɕe kɯɕɯŋgɯ tɕe tɯtsʰot pɯ-me tɕe  nɯnɯ cʰɯ-ɬoʁ lu-ɕqʰlɤt nɯra ɕ-tu-kɯ-ru tɕe, nɯnɯ kɤ-rɤru mda mɤ-mda cʰondɤre kɯ-rɤma kɤ-ɕe mda mɤ-mda nɯtɕu ɕ-tu-kɯ-ru pɯ-ŋgrɤl. \\
 ...
 \glt  `In former times, there were no clocks, and people used to go and watch when [these stars] came out or disappeared [to find out] whether it was time to get up or go to work.' (29-LAntshAm, 66) (\japhdoi{0003726\#S60})
  \end{exe}
