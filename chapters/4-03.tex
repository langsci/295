...
In (\ref{ex:erchacun.kukWCe}) \iai{Tshendzin} hesitates: she was about to say \forme{ɲɯ-kɯ-ɕe} with a \textsc{westwards} preverb (the expected form, based on the geographical location of these localities), followed by the the correct \forme{ku-kɯ-ɕe} with the irregular orientation.
