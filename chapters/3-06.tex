...
\glt `When one calls a cat, one says \forme{tɕítɕi tɕítɕi tɕítɕi} and it comes.' (06-huchements1)
...
Several particles mark a question inviting the addressee to confirm what the speaker has said: \forme{ɣe}, which even resembles an interjection in that it can be preceded by a pause as in (\ref{ex:totsu.Ge}), \forme{nétɕi} (\ref{ex:YWNu.netCi}, \ref{ex:totia.Nu.netCi}) and \forme{loβtɕi} (\ref{ex:tWsla.tomtshAt.loBtCi}).
...
\glt `Rkangrang, you dealt with my son in the same way as you did with my husband (i.e. had him killed), don't go over the top in your torturing of me (torture me with proper measure), please?' (Norbzang 2012) 	(\japhdoi{0003768\#S185})
  \end{exe}
...
\glt  `You are really intelligent, you are not a common man, you are your father's son indeed.' (Norbzang 2012)
...
\glt `The people on earth (`on the ground'), how lucky they are, right? How happy there are!' (150828 donglang) (\japhdoi{0006312\#S26})
\end{exe} 
