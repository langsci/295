...
\glt `[The species of ants called \forme{cɤmi qro}] goes into wood and eats it, and stays in there, (...) and makes holes everywhere in it.' (26-qro, 94-96)
\end{exe} 
...
\glt `When one calls a cat, one says \forme{tɕítɕi tɕítɕi tɕítɕi} and it comes.' (06-huchements1, 34-33)
...
\glt `If [the cow] has white colour on the back (and is given the name \forme{rgɯskɯ}), one says \forme{aβleβle rgɯskɯ} and she understands, and comes by herself.' (06-huchements1, 3)
\end{exe}
