...
This chapter first presents an overview of the structure of the verb in Japhug, including the prefixal (§\ref{sec:prefixal.chain}) and suffixal (§\ref{sec:suffixes}, §\ref{sec:peg.circumfix}) chains. The final sections discusses the templatic structure of Japhug verbal morphology (§\ref{sec:templatic.verb}) and word boundaries (§\ref{sec:wordhood.verb}).
...
\begin{tabular}{l|llllll|l|llll|llll}
\lsptoprule
