...
\glt `(Let us hope that) the dhole will not come to eat you.' (elicited1)
\end{exe}
...
\glt `If he$_i$ needs it$_j$, then he$_i$ does not have to come and give it$_j$ to you (if he does not want to).' (elicited1) 
\end{exe}
...
\glt `I saw the two of them.' (elicited1)
\end{exe}
...
\gll  ɯmɤ-pɯ-kɯ-mto-t$^{+1}$-a$^{+2}$-ndʑi$^{+3}$-ci$^{+4}$ \\
 ...
 \glt `It looks like I have seen the two of them.' (elicited1)
\end{exe} 
...
\glt `You didn't sew your garment, did you? (worried that the subject might have sewed his/her garment)' (elicited1)
...
\glt `It looks like you haven't sewed your garment, it still has a hole.' (elicited1)
\end{xlist}
\end{exe}
...
\glt `He probably has already arrived.' (elicited1)
...
\glt `It seems that he has probably arrived.'  (elicited1)
\end{xlist}
\end{exe}
...
\glt `It looks like you have forgotten about it.' (elicited1)
\end{exe}
...
\glt `It looks like I have seen you.' (elicited1)
\end{exe}
%pjɤ-ta-mto ɯ-mdoʁ
...
\glt `It looks like he has forgotten about me.' (elicited1)
\end{exe}

Although complex forms such as (\ref{ex:WmAjAkWzGWtci}), (\ref{ex:WmAnWkWnWjmWta}), (\ref{ex:WmAnWtWnWjmWtci}) or (\ref{ex:WmApWtamto}) can be elicited1, in the corpus the combination of circumfix with Rhetorical Interrogative or Probabilitative prefixes only occur on stative verbs in \textsc{3sg} form, and mainly with copulas, existential or modal auxiliaries.
...
Bipartite verbs cannot be easily subjected to verbal derivations. The only example that could be elicited1 is the tropative verb (§\ref{sec:tropative}) \forme{nɤ-stu-mbat} `consider that X tries hard'. Only the quasi-compound form of the bipartite verb can be derived. The derivational prefix \forme{nɤ-} cannot be repeated on the $V_1$ and the $V_2$ (a form such as $\dagger$\forme{nɤ-stu=nɤ-stu} is incorrect).
...
\glt `You$_{sg}$ are innocent.' (elicited1)
\end{exe} 
...
\glt `You$_{du}$ are innocent.' (elicited1)
\end{exe} 
