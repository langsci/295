...
\glt `When [nettles] start to cause pain, it won't stop for about one hour.' (11-mtshalu, 7-8)
\end{exe}
...
\glt `As for the expression `seven eight' [that your father in law has told] you, seven plus eight equals fifteen, [it means that] you go back [to your husband's home] in fifteen days.' (2005tAwakWcqraR, 39)
\end{exe}
...
\glt `[Its tail] is about half a fathom (i.e. one arm) long.' (24-ZmbrWpGa, 68)
\end{exe}
