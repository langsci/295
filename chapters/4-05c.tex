...
The compound noun \japhug{βɣɤru}{miller} includes as second element the non-redupli\-ca\-ted variant of the same root \forme{-ru} with the same meaning as that of \japhug{rɯru}{guard, take care of} (the first element is from the noun \japhug{βɣa}{mill}, see §\ref{sec:object.verb.compounds}).
