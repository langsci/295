...
\glt `Whether one liked it or not, one had to go.' (14 tApi taRi) (\japhdoi{0003508\#S193})
\end{exe}
...
\glt `The crow says all kinds of things, let it say (whatever it likes), in any case none of it is true.'  (28-qAjdoskAt)
(\japhdoi{0003718\#S24})
\end{exe}
%{ex:atAtWwGnWndza}
...
\glt `Is it the one that I lost? Is it the one that the water took away (\textit{spontaneous})?' (140427 bianfu jingji he shuiniao-zh) (\japhdoi{0003836\#S28})
\end{exe}
...
\glt `He went towards the west (for a long time), very far in the west, and found a lake.' (28-smAnmi) (\japhdoi{0004063\#S87})
\end{exe}
...
\glt `What are you doing, what kind of foolish act are you doing, flee!' (Norbzang 2012)
(\japhdoi{0003768\#S57})
\end{exe}
