...
\ex \label{ex:WkWnWsmAn.GW.smAnba}
 ...
 This construction should not be confused with complement-taking nouns (§\ref{sec:complement.taking.IPN}), and with true genitival constructions with a headless relative clause possessor, as in (\ref{ex:WkWGAwu.GW.tWrNa}), where the noun following the genitive (\forme{tɯ-rŋa} `one's face') is not an argument of the relative clause.
...
\textsc{3sg} \textsc{erg} vegetable what \textsc{aor}:3\fl{}3'-eat \textsc{dem} \textsc{gen} \textsc{3sg}.\textsc{poss}-colour \textsc{dem} \textsc{ipfv}-take[III] \textsc{sens}-be \\
...
\textsc{indef}.\textsc{poss}-seed \textsc{total}\redp{}\textsc{aor}:3\fl{}3':\textsc{down}-bring-\textsc{du} \textsc{emph} \textsc{dem} \textsc{ifr}-plant-\textsc{du} \\
...
\glt `That (thing that) is called \forme{pɣɤrnoʁ} is probably (to be classified) among the fungi.' (22-BlamajmAG, 140)
\end{exe}  
...
\glt `The top part (of the mushroom called \forme{kuɣrummɤɣ} `white mushroom') is dark, whitish, it is not pure white.' (21-kuGrummAG, 23)
\end{exe} 
...
\gll [\textbf{skɤm-ndʐi} kɯ-jɯ\emph{}jaʁ], [stu kɯ-jaʁ ʑo] nɯ tu-qɤr-nɯ tɕe \\
...
When the relativized element is a noun such as \japhug{tɯ-tɕʰa}{news} or \japhug{ftɕaka}{manner} which can take adnominal complements (§\ref{sec:complement.taking.nouns}), only head-internal relatives are possible, as prenominal clauses are interpreted as complements instead of relatives. For instance, the head noun \forme{tɯ-tɕʰa} in  (\ref{ex:tWtCha.jAkAGWt}) cannot be moved after the participle: $\dagger$\forme{a-tɕɯ kɯ jɤ-kɤ-ɣɯt \textbf{tɯ-tɕʰa} nɯ} is not accepted.
...
\textsc{indef}.\textsc{poss}-son \textsc{dem} \textsc{erg} \textsc{3sg}.\textsc{poss}-staff \textsc{dem} \textsc{aor}:3\fl{}3':\textsc{east}-spread \textsc{dem} \textsc{3sg}.\textsc{poss}-on \textsc{aor}:\textsc{east}-\textsc{auto}-come.out-\textsc{du} \\
...
\textsc{1sg}.\textsc{poss}-son \textsc{erg} bird \textsc{aor}:3\fl{}3'-see \textsc{dem} \\
...
\textsc{1sg}.\textsc{poss}-son \textsc{erg}  \textsc{aor}:3\fl{}3'-see bird \textsc{dem} \\
...
\textsc{lnk} ox \textsc{erg} \textsc{aor}:3\fl{}3'-say[II] \textsc{dem} \textsc{ifr}-do.like \\
...
ox-\textsc{dim} \textsc{aor}-2\fl{}1-\textsc{caus}-take.back-\textsc{1sg} \textsc{dem} \textsc{aor}:3\fl{}3'-see \textsc{lnk} \\
...
For instance, in (\ref{ex:thWnAqharu.chAnAqharu}), the clause \forme{tʰɯ-nɤqʰaru ɯ-sta} cannot be understood as `the place towards which he had looked back'.
...
ant \textsc{aor}:3\fl{}3'-protect \textsc{dem} \textsc{3sg}.\textsc{poss}-hive \textsc{neg}-\textsc{aor}:3\fl{}3'-\textsc{caus}-take.off \textsc{dem}:\textsc{pl} \textsc{gen} \textsc{3pl}.\textsc{poss}-king \textsc{dem} \textsc{erg} ant \textsc{unexp}:\textsc{foc} thousand five \textsc{emph} \textsc{ifr}-bring \\
...
\glt `When there are many fruits on the trees in the forest, in those years the \textit{Garrulax sp.} (\forme{ʁmɯrcɯ}) are fewer because they do not come (where they can be) seen, because they have \textbf{something} to eat (in the forest).' (23-pGAYaR, 89)
\end{exe}
...
wolf two \textsc{du} \textsc{erg} \textsc{dem} \textsc{filler} knife \textsc{aor}:3\fl{}3'-take.out \textsc{dem} \textsc{aor}:3\fl{}3'-see-\textsc{du} \textsc{lnk} really \textsc{emph} \textsc{ifr}-be.afraid-\textsc{du} \\
...
In (\ref{ex:yazi.tAkAmWrkW}), we find a series of non-finite verb forms in \forme{kɯ-} and \forme{kɤ-} in clauses that are object of the complement-taking verb \japhug{fɕɤt}{tell} (§\ref{sec:velar.infinitives.complement.clauses}). Given the meaning of this example, it could appear to be preferrable to analyze these examples as complement clauses, translating \forme{<yazi> tɤ-kɤ-mɯrkɯ, tɤ-kɤ-ndza} as `(he told him) that he had stolen and eaten a duck' and \forme{ɯ-βri ...nɯ-kɯ-ɬoʁ} as `that his body started itching, and that feathers started growing on it'. 
...
An analysis of clauses in \forme{kɤ-} as infinitive complement clauses is restricted to complement-taking verbs which unambiguously select \forme{kɤ-} infinitives of plain intransitive verbs (§\ref{sec:infinitives.participles}, §\ref{sec:velar.infinitives.complement.clauses}). 
...
\textsc{lnk} sorcerer \textsc{erg} \textsc{total}\redp{}\textsc{aor}:3\fl{}3'-say[II] \textsc{dem} \textsc{ifr}-do.like \\
