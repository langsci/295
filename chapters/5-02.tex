...
\glt `When there are many fruits on the trees in the forest, in those years the \textit{Garrulax sp.} (\forme{ʁmɯrcɯ}) are fewer because they do not come [where they can be] seen, because they have \textbf{things} to eat (in the forest).' (23-pGAYaR, 89)
\end{exe}
