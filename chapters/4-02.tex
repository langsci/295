...
\glt `Now that I have (i.e. was given) this apple, I will give it to you also to eat.' (150904 zhongli-zh, 35)
\end{exe}
...
\glt `People say that you should not flee in the direction behind[the yeti], as it would see you and catch you.' (140510 mYWrgAt, 20)
\end{exe}
...
\glt `[The plant called] \forme{pɤŋɤxɕaj}$_i$, when a dog$_j$ eats it$_i$, it makes it$_j$ vomit.' (140505 panaxCAj, 3)
\end{exe}
...
\glt `As the king's servants were about to throw him [into the lake], as they were about to take him away.' (Nyima wodzer2002, 114-115)
\end{exe}
...
\glt `A white thing grows on [meat that has been left to rot], there is something that grows on it, this is also mold.' (20-sWrna, 61)
\end{exe}
...
\begin{exe}
	...
	\glt `He brought[the shoe] to the king.'  (tWxtsa 2003, 16)
\end{exe}
...
\begin{exe}
	...
	\glt `I will give you my daughter in marriage.' (`I will give her to you as your wife') (140428 yonggan de xiaocaifeng-zh, 175)
\end{exe}
