...
The verb \japhug{amɯrpu}{bump one against the other} is a similar case (see example \ref{ex:rNgW.tokAmWrpundZici}, §\ref{sec:pers.pronouns}), but its base verb \japhug{rpu}{bump into} is labile (§\ref{sec:goal.labile}).
