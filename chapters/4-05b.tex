...
The verb \japhug{sɤrtsi}{count as}  (see \ref{ex:tutanWsArtsi}, §\ref{sec:essive.abs}) is the sigmatic causative of \japhug{artsi}{count as} (\ref{ex:mWYArtsi2}), itself passive of the transitive \japhug{rtsi}{count}  (from \tibet{རྩི་}{rtsi}{count}).
