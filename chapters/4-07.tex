...
\glt `I am not saying it to you, I am saying it to Padma 'Od'bar.' (Norbzang 2005)
\end{exe}
...
With dynamic verbs however, the Imperfective does occur to express general knowledge, especially in generic forms (as in \forme{tú-wɣ-fskɤr}  \textsc{ipfv}-\textsc{inv}-surround  `it surrounds it' above)  or with a dummy subject (S/A) (\forme{pjɯ-ʑe} \textsc{ipfv}-begin[III] `it begins' above). 
...
\glt `I have to stay here.' (28-qAjdoskAt) (\japhdoi{0003718\#S75})
\end{exe}
...
\glt `(These days) we are eating only meat, as (domestic) animals have been dying in great numbers (due to a disease).' (2003 kandZislama)
\end{exe}
...
\glt `We have been together for three years now, we are so happy together.' (Norbzang 2005)
\end{exe}
...
\glt `If only I could become a human!' (150819 haidenver-zh) (\japhdoi{0006314\#S229})
\end{exe}
...
\glt `When you arrive within seeing distance from the house, say \forme{qʰihihi} three times.' (qachGa 2012, 164-165) 	(\japhdoi{0004087\#S160})
\end{exe}
...
\glt `I will make myself as quick as the wind, make yourself as light as a feather.' (28-smAnmi, 117-119) (\japhdoi{0004063\#S111})
\end{exe}
...
\glt `I am thinking that if only they attacked in a pack and gored [the lion], they would probably kill it.' (20-RmbroN, 65-67) (\japhdoi{0003560\#S60})
\end{exe}
...
\glt `(In June, when crops are about to grow), [the \forme{tacoʁcoʁ} bird]$_i$ sings in the night, making the sound \forme{coʁcoʁcóʁcoʁcoʁ}, people say that it$_i$  tells (the crops) `Grow by one node everyday!'.' (23-scuz, 113-114)
...
The Imperative is commonly used in complement clauses of modal verbs. The combination of the modal auxiliary \japhug{jɤɣ}{be possible} with an Imperative complement clause expresses that the speaker politely allows the addressee to undertake an action that the addressee himself intends to do, as in (\ref{ex:tAnWndAm.jAG}) and (\ref{ex:tAthe.jAG}).
...
\glt `Go and bring it here; if you do not succeed in going and bringing it here, we will destroy your root and your life.' (Norbzang 2005)
\end{exe}
...
\ex \label{ex:ftCar.kAndzoR.tulhoR}
 ...
 \glt `The next year, when summer arrives, it comes out again.' (of a perennial plant, 19-qachGa mWntoR)
...
\ex \label{ex:tCaGi.tuti}
 ...
 \glt `(Of a parrot which is able to say a few words) When someone comes, [the parrot] says `A guest has arrived', and says `hello'.' (24-qro, 112-113) (\japhdoi{0003626\#S102})
\end{exe}
...
\ex \label{ex:tWtAtWtWt}
 ...
 \glt `If you tell [anyone] about it, I will kill you.' (150901 changfamei-zh) (\japhdoi{0006352\#S48})
\end{exe}
...
\glt `You have become [transformed into] a bird.' (160630 abao-zh)
...
\glt `I was on the terrace eating meat, and suddenly a falcon came down without me noticing, and took away the [piece of] meat in my hand.' (150909 qandZGi, 5-7) (\japhdoi{0006358\#S4})
 \end{exe}
...
\glt `I dreamed that I had become a cricket.' (150904 cuzhi-zh) (\japhdoi{0006322\#S178})
\end{exe}
...
\glt `I have become a slave of the man.' (aesop ma he lu-zh)
\end{exe}
...
\glt `He succeeded in making the black cloud turn back.' (25-kAmYW)
(\japhdoi{0003642\#S61})
\end{exe}
...
\glt  `When the sun has not appeared (yet, in the morning), when clouds come, and there is a little rain, the mosquitoes are particularly numerous.' (25-RmArYWG, 38-39) (\japhdoi{0003652\#S36})
\end{exe}
...
\glt `He almost killed me.' (150901 dongguo xiansheng he lang-zh, 139-141) (\japhdoi{0006336\#S132})
 \end{exe} 
...
\glt `Even lying down, you feel dizzy, and it feels like you are about to fall down.' (29-tAmtshAzkAkWndo, 57-58) (\japhdoi{0004065\#S55})
 \end{exe}
...
\glt `It sings at night, it makes the sound \forme{qaqaqaqa}, that is the pheasant \textit{Pucrasia macrolopha}. They say it is the \textit{Pucrasia macrolopha}, maybe it is, we don't know, at night it is not visible.' (23-pGAYaR, 8-11)
(\japhdoi{0003606\#S7})
 \end{exe}
