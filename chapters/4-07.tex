...
\glt `There is [a mushroom] called \forme{ŋɤqa} (cow's foot), when one looks at it from far away, it is a bit like a puffball.' (22-BlamajmAG, 84)
\end{exe}
...
\glt `When you arrive within seeing distance from the house, say \forme{qʰihihi} three times.' (qachGa 2012, 164-165)
\end{exe}
