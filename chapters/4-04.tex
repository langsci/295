...
This category is difficult to distinguish from denominal verbs from bare action nominals (§\ref{sec:bare.action.nominals}) taking an indefinite possessor prefix \forme{tɯ-}. For instance, the transitive verb \japhug{tɕʰɯ}{gore, stab, pierce} can be used in a light verb construction in \japhug{lɤt}{release} in bare infinitive form, as in (\ref{ex:WtChW.tolAt}).
