...
\gll nɯ-mtɕʰi mɤ-kɯ-pe, kɤ-nɤtsɯ kɯ-ra ra kɯnɤ tu-kɯ-nɯ-ti nɯnɯra tɕaɣi tu-sɤrmi-nɯ ŋgrɤl. \\
 ...
 \glt `People call `parrots', those with a foul mouth, who tell [everything], including things that should [remain] hidden.'
...
\ex \label{ex:ZNgri.YWkWmArZaB}
 ...
 \glt `When there is a shooting star, if one pulls one's hair, it become longer.' (29-mWBZi) 	
 (\japhdoi{0003728\#S93})
\end{exe}
...
\glt `They put a fence around the fields, so as to prevent farm animals to go there.' (140427 qamtsWrmdzu) 	(\japhdoi{0003854\#S13})
\end{exe}
