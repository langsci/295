...
\glt `His wife, who was pregnant, gave birth to a child.' (Norbzang 2012)
(\japhdoi{0003768\#S95})
\end{exe}
...
\ex \label{ex:pjArwGrzWrzWG}
 ...
 \glt `[The thieves] cut him into many sections, they cut him into four sections and killed him.'  (140512 alibaba-zh) (\japhdoi{0003965\#S109})
\end{exe}
...
\glt `There is smoke coming out from their house.' (Norbzang 2012) (\japhdoi{0003768\#S194})
\end{exe} 
...
\glt `I dreamt that I had become a cricket.' (150904 cuzhi-zh)
...
\ex \label{ex:Wthu.tAtWzmAkut}
 ...
 \glt `Bsod.nam sgrub.ldan, you were the first to ask [her in marriage].' (sras 2003)
\end{exe}
