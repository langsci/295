...
\glt `The boy told one of his companions, and that one another one, and [in this way] they informed each other.' (2012 Norbzang, 82)
\end{exe}
...
\glt `The toilets for other people, for normal people (i.e., not lamas), were on the [balcony] facing west under it.' (08-kWqhi, 10)
\end{exe} 
...
\glt `People pour milk for it (i.e., the cat) to drink, and it drinks it.' (21-lWLU, 47)
\end{exe}
...
\glt `If you are the maternal uncle's son, (and I am the nephew) I have to address [you] as `my uncle'.' (140425 kWmdza, 114)
\end{exe}
...
\glt `If [one gets this disease after using the bowl of] someone who is cleaner than oneself, the [pimple] will appear on one's upper lip.' (25-khArWm, 11)
\end{exe}
...
\glt `Someone who spares things (i.e., does not waste anything) even though he is rich, people call him an `earth-sparing earthworm'.' (25-akWzgumba, 136-137)
\end{exe}
...
\glt `And the mother (i.e. lioness) flees with her cubs, and they (i.e. mother and children) have to go alone (without the father).' (20-sWNgi, 75)
\end{exe}
