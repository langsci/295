...
\glt `Maternal uncles and sister's children cannot marry each other.' (140427 kWmdza stWnmW) (\japhdoi{0003844\#S14})
(\japhdoi{0003844\#S14})
\end{exe}
...
\glt `The toilets for other people, for normal people (i.e., not lamas), were on the [balcony] facing west under it.' (08-kWqhi) (\japhdoi{0003454\#S8})
\end{exe} 
...
\glt `Some people use [\textit{Sambucus}] as hogwash, poor pigs, it is so bitter.' (12-ndZiNgri, 30-31)
(\japhdoi{0003488\#S28})
\end{exe}
...
\glt `And when it is about to rain, when one looks towards Qaprangar, a cloud comes out from it. Even now a cloud comes out, and [the elders] say `Qaprangar released a cloud.'' (140522 Kamnyu zgo, 328-330) (\japhdoi{0004059\#S317})
\end{exe}
...
\glt `As for the name of the \textit{Lonicera} sp., [it is because] it has a lot of skins that shed off, one after the other, and after one has shed off, another one grows again inside.' (14-sWNgWJu, 72-5) (\japhdoi{0003506\#S66})
\end{exe}
...
\glt `Someone who spares things (i.e., does not waste anything) even though he is rich, people call him an `earth-sparing earthworm'.' (25-akWzgumba, 136-137) (\japhdoi{0003632\#S125})
\end{exe}
...
\glt `It eats people, so is it called \forme{ndzɤpri}.' (21-pri)
(\japhdoi{0003580\#S91})
\end{exe} 
...
\glt `The `tailless animal' is the man, and `he becomes crazy', [when the crow says] that [people] became crazy, it means that they are sowing seeds.' (22-qajdo, 47-9)
(\japhdoi{0003596\#S46})
\end{exe}
...
\glt `Just before, I had lifted the heddle on the lower (downstream) side [of the loom], now we have to lift the ones on the upper (upstream) side.' (video 20140429090403, 71-72) (\japhdoi{0003776\#S68})
\end{exe}
