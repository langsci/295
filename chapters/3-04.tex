...
While some verbs referring to natural forces are intransitive (\japhug{mnu}{shake} (as an earthquake), §\ref{sec:volitional.mW}), most are morphologically transitive auxiliary verbs (mainly \japhug{lɤt}{release}, \japhug{βzu}{make}, \japhug{ta}{put} and \japhug{rku}{put in}), used in collocation with a noun in absolutive form, as in (\ref{ex:tWmW.YAsWlAt}) and (\ref{ex:qale.taBzu}).
