...
\ex \label{ex:qale.taBzu}
 ...
 \glt `When there is wind suddenly before [the barley] is fully ripe, it presses them [on the ground, and it cannot grow any more].' (25-cWXCWz, 42)
\end{exe}
...
\glt `She married and went to [live in] other people's (her in laws') house.' (14-siblings, 10)
\end{exe}
...
\ex \label{ex:nɯmthAG.YWrtABnW}
 ...
 \glt `People attach [badger skin] around their waist (as a remedy for rheumatism).' (27-spjaNkW, 135)
\end{exe}
...
\glt `And like that, she sent me letters, and I sent her letters.' (12-BzaNsa, 26)
\end{exe}
...
\glt `You need ten [renminbis] per pound [of Angelica].' (17 ndZWnW, 22)
\end{exe}  
...
\ex \label{ex:RnWpArme.mACtsxa}
 ...
 \glt `In [families where] children are numerous, [mothers] breastfeed [the children] until [they are] one or two years old.' (140426 tApAtso kAnWBdaR, 13)
\end{exe}
...
\glt  `I will accompany you until the [land of the] east.' (28-smAnmi, 220)
\end{exe}
...
\end{exe}
 ...
 \begin{exe}
	...
	\glt `Please gather [everybody], from the miller (i.e. the lowliest of servants) up [to the highest ranking person].' (2003 kandZislama, 174)
\end{exe}
...
\ex \label{ex:aʑo.CWNgW}
 ...
 \glt `Before [you choose a name for] me, [choose] the names of my elder brothers up there first.' (Gesar, 124)
\end{exe}
...
\glt `[When you are] close to the sun, the moon and the stars, you will have to bear [the heat and the cold], otherwise...' (2003kandZislama, 53)
\end{exe}
...
\ex \label{ex:tArAku.tArca}
 ...
 \glt `Buckwheat is a type of crops, it is not a [type of] grass.' (13-NanWkWmtsWG, 68)
\end{exe}
...
\glt `Take these [as a compensation] instead of having me [as your wife].' (2003kAndzwsqhaj2, 141)
\end{exe}
...
\glt `[The mother] kissed [her children] one after the one and had them come inside.' (160701 poucet2, 38)
\end{exe}
...
\gll   tɤ-zdɯɣ ɯ-xɕɤt kɯ pjɯ-si ɕti, \\
 ...
 \glt `[The bees] die of exhaustion.' (26 GZo, 40)
  \end{exe}
