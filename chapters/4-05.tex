...
\glt `My children are about to come back and will try to eat you, I have to hide you (help you hide).' (2012 Norbzang)
...
\glt `The king sent his youngest son to guard [the apple trees].' (140507 jinniao-zh)
(\japhdoi{0003931\#S37})
\end{exe}
...
\glt `[The mole] does like this with its forepaws, and throws the earth below.' (28-qapar)
...
\glt `Milk tea is [the type of tea] that we Tibetans like most.' (05-qaZo)
...
\glt `Coloured belts are something that we Tibetan woman must absolutely have, and it is what we like most.' (thaXtsa 2002)
\end{exe}
...
\glt `I used to like to observe bugs.' (26-quspunmbro)
(\japhdoi{0003684\#S15})
\end{exe}
