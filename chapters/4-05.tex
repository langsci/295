...
Color stative verbs and stative verbs related to disease and pain (\japhug{ngo}{get sick}, \japhug{mŋɤm}{feel pain} etc) also form their causative with \forme{sɯ-} and its variants rather than with \forme{ɣɤ\trt}, as seen in the table above.
...
\is{applicative!allomorphy}\is{morphology!allomorphy}
...
\subsection{Allomorphy} \label{sec:tropative.allomorphy}
  \is{tropative!allomorphy}\is{morphology!allomorphy}
