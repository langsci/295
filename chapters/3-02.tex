...
\textsc{lnk} yet something \textsc{aor}:3\fl3'-\textsc{auto}-put.in-\textsc{pl} \textsc{sfp} \\
...
\ex \label{ex:kWki.kW.taBzu}
 \gll  kɯki kɯ ta-βzu? \\
 \textsc{dem}.\textsc{prox} \textsc{erg} \textsc{aor}:3\fl3'-make \\
...
female.yak \textsc{dem} \textsc{erg} male.young.bovid \textsc{aor}:3\fl3' \textsc{lnk} \textsc{lnk} \textsc{dem}:\textsc{cataph} \textsc{sens}-be male.hybrid.yak \textsc{sens}-be \\
