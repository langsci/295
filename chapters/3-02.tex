...
\glt `Instead of guns and other things like you, we$_{DU.EXCL}$ only had a staff, and we$_{DU.EXCL}$ used it as a bridge (to cross the river).' (2003 Kunbzang, 164)
\end{exe}
...
\glt `People say that [chicken eggs] hatch after twenty-one days, mine took twenty-two days to hatch.' (150819 kumpGa, 35)
\end{exe} 
...
\glt `Finally, which type [of being] are you?' (smanmi 2003, 172)
\end{exe}  
...
\glt `I don't what [the wasp] uses to make [its nest$_i$], it$_i$ is attached on trees like that.' (26-ndzWrnaR, 55)
\end{exe} 
...
\glt `[You say] that your father-in-law went away to give birth to a child, but since when can a man bear children?' (tAwa kWCqraR, 99)
\end{exe} 
...
\gll  tɯ-xpa tɕe ci kɯ tɯ-rdoʁ pjɤ-sat. \\
 ...
 \glt `One year, someone killed one [wild goose].' (22-qomndroN, 43)
\end{exe}
...
\glt `They also probably gave them something else.' (02-deluge 2012, 120)
 \end{exe}
...
\glt `[The cat]$_i$ reaches with its$_i$ paw [into the hole] like this, but the other one (the weasel) bites its$_i$ paw.' (27-spjaNkW, 48)
\end{exe}
...
\glt `While one of the two (i.e. the prey) is (still) going, the other one (i.e. the predator) eats and pulls its intestine.'  (20-RmbroN, 76)
\end{exe}
...
\glt `An Arhat is... it is Buddhist statue.' (150829 jidian, 135)
\end{exe}
...
\ex \label{ex:nWtCu.zW.mbro}
 ...
 \glt `There are stables (in this palace), and the horse is kept there.' (140507 jinniao-zh, 174)
\end{exe} 
...
\glt `\textbf{At that time} (i.e. the time of the dinosaurs), humans did not exist yet.' (180421 bawanglong, 33)
\end{exe}
...
\glt `But even under those circumstances (i.e. working in different places, and meeting only once a year), we did not lose our friendship.' (12-BzaNsa, 42)
\end{exe}
...
\glt `I have learned how to say ``ball'', people from Tshobdun call it \forme{rgoŋlu}, we [do not have this word in Japhug but] this is how I am going to say it here (in this story). (140514 huishuohua de niao-zh, 4)
\end{exe}
