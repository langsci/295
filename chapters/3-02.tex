...
Universal concessive conditionals are found with the pronoun \japhug{ŋotɕu}{where}, with the meaning `no matter where, wherever' (location or direction from or to), as in (\ref{ex:nWGtWta}). This free-choice indefinite meaning of  \forme{ŋotɕu} in also found in the delocutive expression \japhug{ŋɤtɕɯkɤti+kʰɯ}{be obedient}, where the interrogative pronoun occurs in  bound state form \forme{ŋɤtɕɯ-} with the infinitive of \japhug{ti}{speak}  (§\ref{sec:lexicalized.velar.inf}).
